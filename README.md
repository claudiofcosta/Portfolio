...
###### &emsp; 🔸 &nbsp; The `dashboard_transactions_history` is a Streamlit dashboard that allows users to have an overview of his/her investment wallet.<br> &emsp;&emsp;&emsp;&thinsp; App has been deployed [here](https://cfcosta-dashboard-transactions-history.streamlit.app/), using a demo dataset for proof-of-concept.
______________
