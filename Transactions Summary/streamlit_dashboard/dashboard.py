...
st.caption("This dataset represent all individual movements in the wallet. To determine the statys of one position, the method 'First-In First-Out' was used")
