...
- For demonstration, a demo dataset generated by ChatGPT and manually adapted was used. The CSV file is found in the main folder under the name `demo_raw_dataset`.
