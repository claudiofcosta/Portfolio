...
This small app is a dashboard that allows user to have an overview of how his investments compare with the market. App has been deployed here [INSERIR LINK!].
