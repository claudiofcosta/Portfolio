...
df_prod_profit = pd.read_csv ("https://raw.githubusercontent.com/claudiofcosta/Portfolio/main/personal_projects/dashboard_transactions_history/data%20treatment/exported_dataframes/df_prod_profit.csv", index_col=0)
